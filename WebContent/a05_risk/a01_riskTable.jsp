    ...
    <%@ include file="../a01_main/header.jsp" %>
      ...
      <div class="content">
        <div class="col-md-8 ml-auto mr-auto">
          <h2 class="text-center">리스크 관리</h2>
          <p class="text-center">
            <a href="#" target="_blank"></a>
            
           
            <a href="../a05_risk/a03_riskInsert.jsp"><button type="submit" class="btn btn-primary">+리스크 등록</button></a>
          </p>
        </div>
        <div class="row mt-5">
          <div class="col-md-12">
                ...
                <table id="datatable" class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>프로젝트</td>
                      <td>프로젝트1</td>
                      <td><a href="../a05_risk/a02_riskDetail.jsp">조치 완료</a></td>
                      <td>홍길동</td>
                      <td>pm</td>
                      <td>2020-03-04</td>
