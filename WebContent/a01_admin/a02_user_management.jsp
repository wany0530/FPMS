		...
		<div class="main-panel">
			...
			<div class="content">
				...
				<div class="col-md-8 ml-auto mr-auto mb-3">
					<h2 class="text-center m-0">임직원 관리</h2>
				</div>
									...
									<div class="card mb-2">
										...
										<div class="card-body ml-2 mb-0" style="height: 600px;
											...
											<ul class="list-unstyled p-2">
												<li class="user-list">김길동 대리 (IT)</li>
												<li class="user-list">홍길동 대리 (IT)</li>
												<li class="user-list">이길동 대리 (경영지원)</li>
												<li class="user-list">김길동 대리 (전략기획)</li>
												<li class="user-list">김길동 대리 (전략기획)</li>
												<li class="user-list">김길동 대리 (전략기획)</li>
												<li class="user-list">김길동 대리 (전략기획)</li>
												<li class="user-list">김길동 대리 (전략기획)</li>
