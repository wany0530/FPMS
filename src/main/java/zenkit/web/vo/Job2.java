...
public class Job2 {
	...
	public Date getJ_startD() { return j_startD; }

	public void setJ_startD(Date j_startD) { this.j_startD = j_startD; }

	public Date getJ_endD() { return j_endD; }

	public void setJ_endD(Date j_endD) { this.j_endD = j_endD; }

	public String getJ_startD_s() { return j_startD_s; }

	public void setJ_startD_s(String j_startD_s) { this.j_startD_s = j_startD_s; }
